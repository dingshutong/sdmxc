...
Using the Google API and DeepL tabs, users can enter authentication credentials for automated translation using Google Translation or DeepL API.

The Proxy tab allows specifying the proxy settings for the internet connection if a proxy is needed.
\textbar{}

: \label{tab:table31} A bird's-eye view of the menu items in the top right corner (General Functions)
